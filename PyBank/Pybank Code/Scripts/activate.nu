...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\boot camp\Challenge\3rd challenge\starter code for challenge\Pybank code'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\boot camp\Challenge\3rd challenge\starter code for challenge\Pybank code\Scripts\deactivate.nu'
